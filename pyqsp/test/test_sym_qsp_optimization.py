...
class Test_sym_qsp_optimization(unittest.TestCase):
	...
	def _test_poly_jacobian_components(self):
	...
	def test_poly_jacobian_components_trivial(self):
		...
		qsp_protocol = sym_qsp_opt.SymmetricQSPProtocol(reduced_phases=[np.pi/4,np.pi/4,np.pi/4], poly_deg=3)
